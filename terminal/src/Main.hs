  ...
  let
    ...
    makeFlags =
      flags Make.Flags
        ...
        |-- flag "output" Make.output "Specify the name of the resulting JS file. For example --output=assets/elm.js to generate the JS at assets/elm.js, --output=assets/elm.mjs to generate an ES module instead, or --output=/dev/null to generate no output at all!"
